 ...
 */
package com.xlist.pull.refresh;
...
public class XListView extends ListView implements OnScrollListener {
    ...
    private void startLoadMore() {
        ...
        if (mListViewListener != null) {
            mListViewListener.onLoadMore(XListView.this);
        }
    }
        ...
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (null != mListViewListener) {
                    mListViewListener.onTouch(true);
                }
                break;
            ...
            default:
                mLastY = -1; // reset
                int footerViewBottomMargin = mFooterView.getBottomMargin();
                //一下代码存在bug，footerViewBottomMargin 并不能精准定位
                if (mEnablePullLoad && mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA) {
//				startLoadMore();//如果打开注释，则会出现bug
                    resetFooterHeight();
                ...
                if (null != mListViewListener) {
                    mListViewListener.onTouch(false);
                }
                break;
        }
