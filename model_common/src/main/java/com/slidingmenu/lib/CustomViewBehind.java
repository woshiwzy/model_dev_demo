...
//
//        if ("Nexus 5".equals(model) && "5.1".equals(vsystem)||
//                "Nexus 5".equals(model) && "6.0".equals(vsystem)
//                ) {
//            int nbarheight = Tool.getNavigationBarHeight(((Activity) getContext()));
//            contentHeight = contentHeight - nbarheight;
////            LogUtil.i("wzy", "slidemenu height:" + height + " [" + model + "[" + vsystem + "[" + nbarheight);
//        }
